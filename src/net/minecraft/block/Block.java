...
public class Block
{
    ...
    public static void registerBlocks() {
        ...
        for (final Block block1 : Block.blockRegistry) { // Renamed var15 to block1
            if (block1.blockMaterial == Material.air) {
                block1.useNeighborBrightness = false;
            } else {
                boolean var16 = false;
                final boolean var17 = block1 instanceof BlockStairs;
                final boolean var18 = block1 instanceof BlockSlab;
                final boolean var19 = block1 == var7;
                final boolean var20 = block1.translucent;
                final boolean var21 = block1.lightOpacity == 0;
                if (var17 || var18 || var19 || var20 || var21) {
                    var16 = true;
                }
                block1.useNeighborBrightness = var16;
            }
        }

        for (final Block block2 : Block.blockRegistry) { // Renamed var15 to block2
            for (final IBlockState state : block2.getBlockState().getValidStates()) {
                final int var24 = Block.blockRegistry.getIDForObject(block2) << 4 | block2.getMetaFromState(state);
                Block.BLOCK_STATE_IDS.put(state, var24);
            }
        }
